...
public class ManagePersonServlet extends HttpServlet {
    ...
    private String validatePersonFMLName(Person person) {
        ...
        if (!person.validateFMLNamePart(person.getName(), false)) {
            error_message.append("Имя должно быть строкой от 1 до 150 символов из букв, цифр, знаков подчёркивания и знаков минус.<br />");
        }

        if (!person.validateFMLNamePart(person.getSurname(), false)) {
            error_message.append("Фамилия должна быть строкой от 1 до 150 символов из букв, цифр, знаков подчёркивания и знаков минус.<br />");
        }

        if (!person.validateFMLNamePart(person.getMiddlename(), true)) {
            error_message.append("Отчество должно быть строкой от 0 до 150 символов из букв, цифр, знаков подчёркивания и знаков минус.<br />");
        }
    ...
    private String validatePhone(String number) {
        ...
        if (!Person.validatePhone(number)) {
            error_message.append("Телефон должен быть строкой от 2 до 50 символов из цифр и знаков +, -, #.<br />");
        }
        return error_message.toString();
    }
        ...
        // Если же действие указано, то...
            ...
            switch (action) {
                ...
                case "add_phone":
                    ...
                    jsp_parameters.put("next_action", "add_go_p");
                ...
                case "edit_phone":
                    ...
                    jsp_parameters.put("next_action", "edit_go_p");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String add_go_p = request.getParameter("add_go_p");
        String edit_go_p = request.getParameter("edit_go_p");
